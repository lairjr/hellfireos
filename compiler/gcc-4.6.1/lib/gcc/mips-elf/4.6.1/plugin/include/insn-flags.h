...
#define HAVE_mulsi3_internal (!TARGET_FIX_R4000 && !TARGET_NO_HW_MULT)
#define HAVE_muldi3_internal ((!TARGET_FIX_R4000 && !TARGET_NO_HW_MULT) && (TARGET_64BIT))
#define HAVE_mulsi3_r4000 (TARGET_FIX_R4000)
#define HAVE_muldi3_r4000 ((TARGET_FIX_R4000) && (TARGET_64BIT))
#define HAVE_mulsidi3_32bit (!TARGET_64BIT && (!TARGET_FIX_R4000 || ISA_HAS_DSP) && !TARGET_NO_HW_MULT)
#define HAVE_umulsidi3_32bit (!TARGET_64BIT && (!TARGET_FIX_R4000 || ISA_HAS_DSP) && !TARGET_NO_HW_MULT)
...
#define HAVE_smulsi3_highpart_internal (!ISA_HAS_MULHI && !TARGET_NO_HW_MULT)
#define HAVE_umulsi3_highpart_internal (!ISA_HAS_MULHI && !TARGET_NO_HW_MULT)
...
#define HAVE_umaddsidi4 ((TARGET_MAD || ISA_HAS_MACC || GENERATE_MADD_MSUB || ISA_HAS_DSP) \
   && !TARGET_64BIT)
#define HAVE_divmodsi4 (!TARGET_FIX_VR4120 && !TARGET_NO_HW_DIV)
#define HAVE_divmoddi4 ((!TARGET_FIX_VR4120 && !TARGET_NO_HW_DIV) && (TARGET_64BIT))
#define HAVE_udivmodsi4 (!TARGET_NO_HW_DIV)
#define HAVE_udivmoddi4 ((!TARGET_NO_HW_DIV) && (TARGET_64BIT))
...
#define HAVE_mov_lwl (!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (SImode, operands[1]))
#define HAVE_mov_ldl ((!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (DImode, operands[1])) && (TARGET_64BIT))
#define HAVE_mov_lwr (!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (SImode, operands[1]))
#define HAVE_mov_ldr ((!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (DImode, operands[1])) && (TARGET_64BIT))
#define HAVE_mov_swl (!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdl ((!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
#define HAVE_mov_swr (!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdr ((!TARGET_MIPS16 && !TARGET_PATFREE && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
...
#define HAVE_mulsf3 ((!TARGET_NO_HW_MULT) && (TARGET_HARD_FLOAT))
#define HAVE_muldf3 ((!TARGET_NO_HW_MULT) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_mulsi3 (!TARGET_NO_HW_MULT)
#define HAVE_muldi3 ((!TARGET_NO_HW_MULT) && (TARGET_64BIT))
#define HAVE_mulsidi3 (mips_mulsidi3_gen_fn (SIGN_EXTEND) != NULL && !TARGET_NO_HW_MULT)
#define HAVE_umulsidi3 (mips_mulsidi3_gen_fn (ZERO_EXTEND) != NULL && !TARGET_NO_HW_MULT)
#define HAVE_smulsi3_highpart (!TARGET_NO_HW_MULT)
#define HAVE_umulsi3_highpart (!TARGET_NO_HW_MULT)
...
#define HAVE_extv (!TARGET_MIPS16 && !TARGET_PATFREE)
#define HAVE_extzv (!TARGET_MIPS16 && !TARGET_PATFREE)
#define HAVE_insv (!TARGET_MIPS16 && !TARGET_PATFREE)

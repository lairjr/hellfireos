...
#define MASK_NO_HW_DIV (1 << 20)
#define MASK_NO_HW_MULT (1 << 21)
#define MASK_PAIRED_SINGLE_FLOAT (1 << 22)
#define MASK_PATFREE (1 << 23)
...
#define TARGET_NO_HW_DIV ((target_flags & MASK_NO_HW_DIV) != 0)
#define TARGET_NO_HW_MULT ((target_flags & MASK_NO_HW_MULT) != 0)
#define TARGET_PAIRED_SINGLE_FLOAT ((target_flags & MASK_PAIRED_SINGLE_FLOAT) != 0)
#define TARGET_PATFREE ((target_flags & MASK_PATFREE) != 0)
...
enum opt_code
{
  ...
  OPT_Whiding = 230,                         /* -Whiding */
  OPT_Wignored_qualifiers = 231,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 232,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 233,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 234,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 235,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 236,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 237, */                   /* -Wimport */
  OPT_Windirect_static = 238,                /* -Windirect-static */
  OPT_Winit_self = 239,                      /* -Winit-self */
  OPT_Winline = 240,                         /* -Winline */
  OPT_Wint_to_pointer_cast = 241,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 242,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 243,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 244,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 245,                 /* -Wintrinsics-std */
  OPT_Winvalid_offsetof = 246,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 247,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 248,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 249,               /* -Wjump-misses-init */
  OPT_Wl_ = 250,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 251, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 252,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 253,                /* -Wline-truncation */
  OPT_Wlocal_hiding = 254,                   /* -Wlocal-hiding */
  OPT_Wlogical_op = 255,                     /* -Wlogical-op */
  OPT_Wlong_long = 256,                      /* -Wlong-long */
  OPT_Wmain = 257,                           /* -Wmain */
  OPT_Wmasked_catch_block = 258,             /* -Wmasked-catch-block */
  ...
  OPT_Wnested_externs = 269,                 /* -Wnested-externs */
  OPT_Wnls = 270,                            /* -Wnls */
  OPT_Wno_effect_assign = 271,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 272,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 273,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 274,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 275,                        /* -Wnonnull */
  OPT_Wnormalized_ = 276,                    /* -Wnormalized= */
  OPT_Wnull = 277,                           /* -Wnull */
  OPT_Wold_style_cast = 278,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 279,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 280,           /* -Wold-style-definition */
  OPT_Wout_of_date = 281,                    /* -Wout-of-date */
  OPT_Wover_ann = 282,                       /* -Wover-ann */
  OPT_Woverflow = 283,                       /* -Woverflow */
  OPT_Woverlength_strings = 284,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 285,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 286,                  /* -Woverride-init */
  OPT_Wp_ = 287,                             /* -Wp, */
  OPT_Wpacked = 288,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 289,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 290,                         /* -Wpadded */
  OPT_Wparam_assign = 291,                   /* -Wparam-assign */
  OPT_Wparentheses = 292,                    /* -Wparentheses */
  OPT_Wpkg_default_method = 293,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 294,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 295,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 296,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 297,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 298,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 299,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 300,                       /* -Wprotocol */
  OPT_Wpsabi = 301,                          /* -Wpsabi */
  OPT_Wraw = 302,                            /* -Wraw */
  ...
  OPT_Wselector = 308,                       /* -Wselector */
  OPT_Wsequence_point = 309,                 /* -Wsequence-point */
  OPT_Wserial = 310,                         /* -Wserial */
  OPT_Wshadow = 311,                         /* -Wshadow */
  OPT_Wsign_compare = 312,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 313,                /* -Wsign-conversion */
  OPT_Wsign_promo = 314,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 315,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 316,                /* -Wstack-protector */
  OPT_Wstatic_access = 317,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 318,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 319,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 320,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 321,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 322,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 323,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 324,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 325,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 326,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 327,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 328,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 329,                       /* -Wsuppress */
  OPT_Wsurprising = 330,                     /* -Wsurprising */
  OPT_Wswitch = 331,                         /* -Wswitch */
  ...
  OPT_Wsynthetic_access = 336,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 337,                 /* -Wsystem-headers */
  OPT_Wtabs = 338,                           /* -Wtabs */
  OPT_Wtasks = 339,                          /* -Wtasks */
  ...
  OPT_Wtype_hiding = 344,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 345,                    /* -Wtype-limits */
  OPT_Wuncheck = 346,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 347,            /* -Wundeclared-selector */
  OPT_Wundef = 348,                          /* -Wundef */
  OPT_Wunderflow = 349,                      /* -Wunderflow */
  OPT_Wuninitialized = 350,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 351,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 352,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 353,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 354, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 355,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 356,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 357,                         /* -Wunused */
  OPT_Wunused_argument = 358,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 359,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 360,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 361,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 362,                /* -Wunused-function */
  OPT_Wunused_import = 363,                  /* -Wunused-import */
  OPT_Wunused_label = 364,                   /* -Wunused-label */
  OPT_Wunused_local = 365,                   /* -Wunused-local */
  OPT_Wunused_macros = 366,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 367,               /* -Wunused-parameter */
  OPT_Wunused_private = 368,                 /* -Wunused-private */
  OPT_Wunused_result = 369,                  /* -Wunused-result */
  OPT_Wunused_thrown = 370,                  /* -Wunused-thrown */
  OPT_Wunused_value = 371,                   /* -Wunused-value */
  OPT_Wunused_variable = 372,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 373,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 374,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 375,                /* -Wvariadic-macros */
  OPT_Wvla = 376,                            /* -Wvla */
  OPT_Wvolatile_register_var = 377,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 378,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 379,                  /* -Wwrite-strings */
  OPT_Xassembler = 380,                      /* -Xassembler */
  OPT_Xlinker = 381,                         /* -Xlinker */
  OPT_Xpreprocessor = 382,                   /* -Xpreprocessor */
  OPT_Z = 383,                               /* -Z */
  OPT_ansi = 384,                            /* -ansi */
  OPT_aux_info = 385,                        /* -aux-info */
  /* OPT_aux_info_ = 386, */                 /* -aux-info= */
  OPT_auxbase = 387,                         /* -auxbase */
  OPT_auxbase_strip = 388,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 389, */             /* -bootclasspath */
  OPT_c = 390,                               /* -c */
  /* OPT_classpath = 391, */                 /* -classpath */
  OPT_coverage = 392,                        /* -coverage */
  OPT_cpp = 393,                             /* -cpp */
  OPT_cpp_ = 394,                            /* -cpp= */
  OPT_d = 395,                               /* -d */
  OPT_dumpbase = 396,                        /* -dumpbase */
  OPT_dumpdir = 397,                         /* -dumpdir */
  OPT_dumpmachine = 398,                     /* -dumpmachine */
  OPT_dumpspecs = 399,                       /* -dumpspecs */
  OPT_dumpversion = 400,                     /* -dumpversion */
  OPT_e = 401,                               /* -e */
  /* OPT_encoding = 402, */                  /* -encoding */
  OPT_export_dynamic = 403,                  /* -export-dynamic */
  OPT_extdirs = 404,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 405, */               /* -fCLASSPATH= */
  OPT_fPIC = 406,                            /* -fPIC */
  OPT_fPIE = 407,                            /* -fPIE */
  OPT_fRTS_ = 408,                           /* -fRTS= */
  OPT_fabi_version_ = 409,                   /* -fabi-version= */
  OPT_faccess_control = 410,                 /* -faccess-control */
  ...
  OPT_fasm = 428,                            /* -fasm */
  OPT_fassert = 429,                         /* -fassert */
  OPT_fassociative_math = 430,               /* -fassociative-math */
  OPT_fassume_compiled = 431,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 432,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 433,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 434,                   /* -fauto-inc-dec */
  OPT_fautomatic = 435,                      /* -fautomatic */
  OPT_faux_classpath = 436,                  /* -faux-classpath */
  OPT_fbackslash = 437,                      /* -fbackslash */
  OPT_fbacktrace = 438,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 439,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 440,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 441,              /* -fbootstrap-classes */
  OPT_fbounds_check = 442,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 443,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 444,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 445,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 446,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 447,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 448,                        /* -fbuiltin */
  OPT_fbuiltin_ = 449,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 450,                    /* -fcall-saved- */
  OPT_fcall_used_ = 451,                     /* -fcall-used- */
  OPT_fcaller_saves = 452,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 453,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 454,                /* -fcheck-data-deps */
  OPT_fcheck_new = 455,                      /* -fcheck-new */
  OPT_fcheck_references = 456,               /* -fcheck-references */
  OPT_fcheck_ = 457,                         /* -fcheck= */
  OPT_fclasspath_ = 458,                     /* -fclasspath= */
  OPT_fcoarray_ = 459,                       /* -fcoarray= */
  ...
  OPT_fcompile_resource_ = 466,              /* -fcompile-resource= */
  ...
  OPT_fconvert_big_endian = 472,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 473,          /* -fconvert=little-endian */
  OPT_fconvert_native = 474,                 /* -fconvert=native */
  OPT_fconvert_swap = 475,                   /* -fconvert=swap */
  OPT_fcprop_registers = 476,                /* -fcprop-registers */
  OPT_fcray_pointer = 477,                   /* -fcray-pointer */
  OPT_fcrossjumping = 478,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 479,               /* -fcse-follow-jumps */
  ...
  OPT_mabi_ = 944,                           /* -mabi= */
  OPT_mabicalls = 945,                       /* -mabicalls */
  OPT_mad = 946,                             /* -mad */
  OPT_march_ = 947,                          /* -march= */
  OPT_mbranch_cost_ = 948,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 949,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 950,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 951,                 /* -mcode-readable= */
  OPT_mdebug = 952,                          /* -mdebug */
  OPT_mdebugd = 953,                         /* -mdebugd */
  OPT_mdivide_breaks = 954,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 955,                   /* -mdivide-traps */
  OPT_mdmx = 956,                            /* -mdmx */
  OPT_mdouble_float = 957,                   /* -mdouble-float */
  OPT_mdsp = 958,                            /* -mdsp */
  OPT_mdspr2 = 959,                          /* -mdspr2 */
  OPT_meb = 960,                             /* -meb */
  OPT_mel = 961,                             /* -mel */
  OPT_membedded_data = 962,                  /* -membedded-data */
  OPT_mexplicit_relocs = 963,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 964,                   /* -mextern-sdata */
  OPT_mfix_r10000 = 965,                     /* -mfix-r10000 */
  OPT_mfix_r4000 = 966,                      /* -mfix-r4000 */
  OPT_mfix_r4400 = 967,                      /* -mfix-r4400 */
  OPT_mfix_sb1 = 968,                        /* -mfix-sb1 */
  OPT_mfix_vr4120 = 969,                     /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 970,                     /* -mfix-vr4130 */
  OPT_mfix4300 = 971,                        /* -mfix4300 */
  OPT_mflip_mips16 = 972,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 973,                    /* -mflush-func= */
  OPT_mfp_exceptions = 974,                  /* -mfp-exceptions */
  OPT_mfp32 = 975,                           /* -mfp32 */
  OPT_mfp64 = 976,                           /* -mfp64 */
  OPT_mfused_madd = 977,                     /* -mfused-madd */
  OPT_mgp32 = 978,                           /* -mgp32 */
  OPT_mgp64 = 979,                           /* -mgp64 */
  OPT_mgpopt = 980,                          /* -mgpopt */
  OPT_mhard_float = 981,                     /* -mhard-float */
  OPT_minterlink_mips16 = 982,               /* -minterlink-mips16 */
  OPT_mips = 983,                            /* -mips */
  OPT_mips16 = 984,                          /* -mips16 */
  OPT_mips3d = 985,                          /* -mips3d */
  OPT_mllsc = 986,                           /* -mllsc */
  OPT_mlocal_sdata = 987,                    /* -mlocal-sdata */
  OPT_mlong_calls = 988,                     /* -mlong-calls */
  OPT_mlong32 = 989,                         /* -mlong32 */
  OPT_mlong64 = 990,                         /* -mlong64 */
  OPT_mmcount_ra_address = 991,              /* -mmcount-ra-address */
  OPT_mmemcpy = 992,                         /* -mmemcpy */
  OPT_mmips_tfile = 993,                     /* -mmips-tfile */
  OPT_mmt = 994,                             /* -mmt */
  OPT_mno_float = 995,                       /* -mno-float */
  OPT_mno_flush_func = 996,                  /* -mno-flush-func */
  OPT_mno_mdmx = 997,                        /* -mno-mdmx */
  OPT_mno_mips16 = 998,                      /* -mno-mips16 */
  OPT_mno_mips3d = 999,                      /* -mno-mips3d */
  OPT_mnohwdiv = 1000,                       /* -mnohwdiv */
  OPT_mnohwmult = 1001,                      /* -mnohwmult */
  OPT_mpaired_single = 1002,                 /* -mpaired-single */
  OPT_mpatfree = 1003,                       /* -mpatfree */
  OPT_mplt = 1004,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1005,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1006,               /* -mrelax-pic-calls */
  OPT_mshared = 1007,                        /* -mshared */
  OPT_msingle_float = 1008,                  /* -msingle-float */
  OPT_msmartmips = 1009,                     /* -msmartmips */
  OPT_msoft_float = 1010,                    /* -msoft-float */
  OPT_msplit_addresses = 1011,               /* -msplit-addresses */
  OPT_msym32 = 1012,                         /* -msym32 */
  OPT_msynci = 1013,                         /* -msynci */
  OPT_mtune_ = 1014,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1015,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1016,                  /* -mvr4130-align */
  OPT_mxgot = 1017,                          /* -mxgot */
  OPT_n = 1018,                              /* -n */
  OPT_no_canonical_prefixes = 1019,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1020,              /* -no-integrated-cpp */
  OPT_noasmopt = 1021,                       /* -noasmopt */
  OPT_nocpp = 1022,                          /* -nocpp */
  OPT_nodefaultlibs = 1023,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1024,                   /* -nostartfiles */
  OPT_nostdinc = 1025,                       /* -nostdinc */
  OPT_nostdinc__ = 1026,                     /* -nostdinc++ */
  OPT_nostdlib = 1027,                       /* -nostdlib */
  OPT_o = 1028,                              /* -o */
  OPT_p = 1029,                              /* -p */
  OPT_pass_exit_codes = 1030,                /* -pass-exit-codes */
  OPT_pedantic = 1031,                       /* -pedantic */
  OPT_pedantic_errors = 1032,                /* -pedantic-errors */
  OPT_pg = 1033,                             /* -pg */
  OPT_pie = 1034,                            /* -pie */
  OPT_pipe = 1035,                           /* -pipe */
  OPT_print_file_name_ = 1036,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1037,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1038,          /* -print-multi-directory */
  OPT_print_multi_lib = 1039,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1040,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1041,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1042,               /* -print-prog-name= */
  OPT_print_search_dirs = 1043,              /* -print-search-dirs */
  OPT_print_sysroot = 1044,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1045,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1046,                          /* -quiet */
  OPT_r = 1047,                              /* -r */
  OPT_remap = 1048,                          /* -remap */
  OPT_s = 1049,                              /* -s */
  OPT_s_bc_abi = 1050,                       /* -s-bc-abi */
  OPT_save_temps = 1051,                     /* -save-temps */
  OPT_save_temps_ = 1052,                    /* -save-temps= */
  OPT_shared = 1053,                         /* -shared */
  OPT_shared_libgcc = 1054,                  /* -shared-libgcc */
  /* OPT_specs = 1055, */                    /* -specs */
  OPT_specs_ = 1056,                         /* -specs= */
  OPT_static = 1057,                         /* -static */
  OPT_static_libgcc = 1058,                  /* -static-libgcc */
  OPT_static_libgcj = 1059,                  /* -static-libgcj */
  OPT_static_libgfortran = 1060,             /* -static-libgfortran */
  OPT_static_libgo = 1061,                   /* -static-libgo */
  OPT_static_libstdc__ = 1062,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1063, */                /* -std=c++03 */
  OPT_std_c__0x = 1064,                      /* -std=c++0x */
  OPT_std_c__98 = 1065,                      /* -std=c++98 */
  OPT_std_c1x = 1066,                        /* -std=c1x */
  /* OPT_std_c89 = 1067, */                  /* -std=c89 */
  OPT_std_c90 = 1068,                        /* -std=c90 */
  OPT_std_c99 = 1069,                        /* -std=c99 */
  /* OPT_std_c9x = 1070, */                  /* -std=c9x */
  OPT_std_f2003 = 1071,                      /* -std=f2003 */
  OPT_std_f2008 = 1072,                      /* -std=f2008 */
  OPT_std_f95 = 1073,                        /* -std=f95 */
  OPT_std_gnu = 1074,                        /* -std=gnu */
  OPT_std_gnu__0x = 1075,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1076,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1077,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1078, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1079,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1080,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1081, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1082, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1083,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1084, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1085, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1086,                     /* -std=legacy */
  OPT_symbolic = 1087,                       /* -symbolic */
  OPT_t = 1088,                              /* -t */
  OPT_time = 1089,                           /* -time */
  OPT_time_ = 1090,                          /* -time= */
  OPT_traditional = 1091,                    /* -traditional */
  OPT_traditional_cpp = 1092,                /* -traditional-cpp */
  OPT_trigraphs = 1093,                      /* -trigraphs */
  OPT_u = 1094,                              /* -u */
  OPT_undef = 1095,                          /* -undef */
  OPT_v = 1096,                              /* -v */
  OPT_version = 1097,                        /* -version */
  OPT_w = 1098,                              /* -w */
  OPT_wrapper = 1099,                        /* -wrapper */
  OPT_x = 1100,                              /* -x */
  OPT_z = 1101,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
